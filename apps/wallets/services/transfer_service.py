...
def transfer_funds(
    ...
    # 2. Pure Idempotency Check (Only returns successful historical movements)
    if idempotency_key:
    ...
    try:
        with transaction.atomic():
            ...
            membership_exists = sender_wallet.memberships.filter(
            ...
            # 7. Immutable Success Entry Creation
    ...
    # 8. Clean Rollback Scopes (No database pollution)
