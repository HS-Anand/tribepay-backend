...
class SplitMemberSerializer(serializers.ModelSerializer):
...
class SplitMemberInputSerializer(serializers.Serializer):
...
class CreateSplitSerializer(serializers.Serializer):
